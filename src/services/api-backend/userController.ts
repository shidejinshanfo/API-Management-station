...
/** uploadUser POST /api/user/upload */
export async function uploadUserUsingPOST(
  body: API.UserUploadRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/user/upload', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
